<table id="welcome">
  <tr>
    ...
    <td valign="top">
      ...
      Everything described here can be done with the evaluation version of SCANeR. If you have not already done so, use the following link to request a copy:
      ![Get a Trial version](https://www.avsimulation.com/scaner-studio-trial/)
    </td>
  </tr>
</table>
